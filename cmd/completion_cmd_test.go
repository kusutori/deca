	...
	tests := []commandTestCase{
		{
			...
			wantErr:      true,
			wantContains: []string{"accepts 1 arg(s), received 0"},
			wantExitCode: 1,
		},
		{
			...
			wantErr:      true,
			wantContains: []string{"unsupported shell"},
			wantExitCode: 1,
		},
		{
			name:         "help output",
			...
			wantErr:      false,
			wantContains: []string{"Generate shell completion scripts", "Usage:"},
			wantExitCode: 0,
		},
		{
